    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        >
          ...
          <span className="text-sm text-cyan-300">API-backed impact intelligence</span>
        </motion.div>
        ...
        >
          <a
            href="#finder"
            className="group px-8 py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-teal-500 text-white font-medium text-lg hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300 flex items-center justify-center gap-2"
          >
            Start Smart Giving
          ...
          <a
            href="/research"
            className="px-8 py-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 text-white font-medium text-lg hover:bg-white/10 transition-all duration-300"
          >
            Explore methodology
          </a>
        </motion.div>
